...
class ExpenseControllerIntegrationTest extends BaseIntegrationTest {
    ...
    void shouldFilterExpensesByDateRange() throws Exception {
        ...
        Expense e1 = new Expense("Today expense", new BigDecimal("10.00"), "Food", today);
        e1.setUser(testUser);
        Expense e2 = new Expense("Yesterday expense", new BigDecimal("20.00"), "Food", yesterday);
        e2.setUser(testUser);
        Expense e3 = new Expense("Last week expense", new BigDecimal("30.00"), "Food", lastWeek);
        e3.setUser(testUser);
        expenseRepository.save(e1);
        expenseRepository.save(e2);
        expenseRepository.save(e3);
    ...
    void shouldSearchExpensesByDescription() throws Exception {
        // Given
        Expense e1 = new Expense("Coffee at Starbucks", new BigDecimal("5.00"), "Food", LocalDate.now());
        e1.setUser(testUser);
    ...
    void shouldGetExpensesByAmountRange() throws Exception {
        // Given
        Expense e1 = new Expense("Small purchase", new BigDecimal("5.00"), "Food", LocalDate.now());
        e1.setUser(testUser);
        Expense e2 = new Expense("Medium purchase", new BigDecimal("50.00"), "Food", LocalDate.now());
        e2.setUser(testUser);
        Expense e3 = new Expense("Large purchase", new BigDecimal("150.00"), "Food", LocalDate.now());
        e3.setUser(testUser);
        expenseRepository.save(e1);
        expenseRepository.save(e2);
        expenseRepository.save(e3);
